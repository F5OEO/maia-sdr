# Package Maia SDR IP core with iio

create_project maia_iio . -force
add_files maia_iio.v
add_files -fileset constrs_1 -norecurse maia_iio.xdc
...
set_property name maia_iio [ipx::current_core]
set_property library maia_iio [ipx::current_core]
set_property display_name {Maia SDR with iio} [ipx::current_core]
set_property description {Maia SDR with iio} [ipx::current_core]
