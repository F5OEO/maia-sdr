...
#add_files -norecurse  ../../adi-hdl/library/util_cdc/sync_bits.v
update_ip_catalog
#IIO MAIA
# default ports
...
ad_ip_instance maia_iio maia_sdr
...
#ad_ip_parameter shiftslicei CONFIG.DIN_FROM 11
#ad_ip_parameter shiftslicei CONFIG.DIN_TO 4
...
#ad_ip_parameter shiftsliceq CONFIG.DIN_FROM 11
#ad_ip_parameter shiftsliceq CONFIG.DIN_TO 4
...
#Select input CS8/CS16 depending on Bit 1 of up_adc_gpio_out

#ad_ip_instance xlslice cs8_slice
#ad_ip_parameter cs8_slice CONFIG.DIN_WIDTH 32
#ad_ip_parameter cs8_slice CONFIG.DIN_FROM 1
#ad_ip_parameter cs8_slice CONFIG.DIN_TO 1
#ad_ip_parameter cs8_slice CONFIG.DOUT_WIDTH 1
#ad_connect axi_ad9361/up_adc_gpio_out cs8_slice/Din
...
ad_ip_instance xlconstant signal_true
ad_ip_parameter signal_true CONFIG.CONST_VAL 1
...
ad_connect muxcs8_tx_q/enable_in_1 signal_true/dout
...
ad_connect muxcs8_tx_q2/enable_in_1 signal_true/dout
